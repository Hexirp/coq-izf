...
# coq_makefile -o makefile *.vInf.v *.vIZF.v 
#
...
.merlin:
	...
	@echo "B C:\Users\hexirp\Documents\programming\coq-izf\theories" >> .merlin
	@echo "S C:\Users\hexirp\Documents\programming\coq-izf\theories" >> .merlin
